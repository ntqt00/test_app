...
class CongViecLienQuanList extends StatefulWidget {
  @override
  _CongViecLienQuanListState createState() => _CongViecLienQuanListState();
}

class _CongViecLienQuanListState extends State<CongViecLienQuanList> {
  int _pageIndex = 0;
    ...
    return BlocBuilder<CongViecCubit, CongViecState>(
      builder: (context, state) {
        if (state is CongViecLoading) {
          ...
          _dataSource = CongViecDataSource(state.khacs,
