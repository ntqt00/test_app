...
class CongViecThucHienList extends StatefulWidget {
  @override
  _CongViecThucHienListState createState() => _CongViecThucHienListState();
}

class _CongViecThucHienListState extends State<CongViecThucHienList> {
  int _pageIndex = 0;
    ...
    return BlocBuilder<CongViecCubit, CongViecState>(
      builder: (context, state) {
        if (state is CongViecLoading) {
          ...
          _dataSource = CongViecDataSource(state.thuchiens,
